...
public interface ITileEntityUnloadable {
	/**
	 * Checks if the BlockEntity is Invalid or Unloaded. Stupid Minecraft cannot do that for the Unloaded Check btw.
	 * Implementing this Function properly is very important, and should be required for every BlockEntity.
