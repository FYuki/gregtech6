...
public interface ITileEntity extends IHasWorldAndCoords, ITileEntityUnloadable, ITileEntityErrorable {
	/**
	 * Sends a Block Event to the Client BlockEntity, the byte Parameters are only for validation as Minecraft doesn't properly write Packet Data.
	 * 
	...
	/** @return the amount of Time this BlockEntity has been loaded. */
	...
	/** Called after the BlockEntity has been placed and set up. */
