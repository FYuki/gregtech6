...
public interface IMultiTileEntity extends ITileEntitySpecificPlacementBehavior {
	...
	public static interface IMTE_GetPlayerRelativeBlockHardness     extends IMultiTileEntity {public float getPlayerRelativeBlockHardness(Player aPlayer, float aOriginal);}
	...
	public static interface IMTE_OnBlockHarvested                   extends IMultiTileEntity {public void onBlockHarvested(int aMetaData, Player aPlayer);}
	...
	public static interface IMTE_IsLadder                           extends IMultiTileEntity {public boolean isLadder(LivingEntity aEntity);}
	...
	public static interface IMTE_GetValidRotations                  extends IMultiTileEntity {public Direction[] getValidRotations();}
