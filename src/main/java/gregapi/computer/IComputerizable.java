...
public interface IComputerizable {
	...
	/** The Function Call itself. The BlockEntity implementing IComputerizable is always the one inside aDelegator. aDelegator is only there for Singletons like Covers, that require more Data access. */
