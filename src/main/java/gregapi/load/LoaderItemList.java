...
public class LoaderItemList implements Runnable {
	...
	public void run() {
		...
		ItemsGT.SHOW_RESISTANCE.add(ST.make(Blocks.DEEPSLATE_REDSTONE_ORE             , 1, W));
		...
		ItemsGT.SHOW_RESISTANCE.add(ST.make(Blocks.TERRACOTTA                , 1, W));
		ItemsGT.SHOW_RESISTANCE.add(ST.make(Blocks.WHITE_TERRACOTTA        , 1, W));
		ItemsGT.SHOW_RESISTANCE.add(ST.make(Blocks.OAK_LEAVES                       , 1, W));
		ItemsGT.SHOW_RESISTANCE.add(ST.make(Blocks.leaves2                      , 1, W));
		ItemsGT.SHOW_RESISTANCE.add(ST.make(Blocks.OAK_PLANKS                       , 1, W));
		ItemsGT.SHOW_RESISTANCE.add(ST.make(Blocks.OAK_LOG                          , 1, W));
		ItemsGT.SHOW_RESISTANCE.add(ST.make(Blocks.DARK_OAK_LOG                         , 1, W));
		...
		ItemsGT.SHOW_RESISTANCE.add(ST.make(Blocks.STONE_BRICKS                   , 1, W));
