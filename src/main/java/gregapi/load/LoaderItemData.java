...
//      OM.reg(OP.stone, MT.CrackedSand                         , ST.make(MD.EBXL, "terrain_blocks2"    , 1, 0));
		...
		OM.reg(OP.stoneBricks                                   , ST.make(Blocks.STONE_BRICKS             , 1, W));
		OM.reg(OP.stoneMossy                                    , ST.make(Blocks.STONE_BRICKS             , 1, 1));
		OM.reg(OP.stoneMossyBricks                              , ST.make(Blocks.STONE_BRICKS             , 1, 1));
		OM.reg(OP.stoneCracked                                  , ST.make(Blocks.STONE_BRICKS             , 1, 2));
		OM.reg(OP.stoneChiseled                                 , ST.make(Blocks.STONE_BRICKS             , 1, 3));
		...
		OM.reg(OP.stone, MT.NetherBrick                         , ST.make(Blocks.NETHER_BRICKS           , 1, W));
...
//      OM.data(MD.TCFM, "WandCaps"                         , 1,   0, MT.Alchemical         ,  5* U9);
		...
		OM.data(ST.make(Blocks.NETHER_BRICKS                  , 1, W), MT.NetherBrick        ,  U * 4);
		...
		OM.data(ST.make(Blocks.STONE_BRICKS                    , 1, W), ANY.Stone             ,  U * 9);
		...
		OM.data(ST.make(Blocks.NOTE_BLOCK                     , 1, W), ANY.Wood              ,  U * 8, MT.Redstone, U);
