...
// PHASE3: import net.minecraft.item.ItemPickaxe removed — use net.minecraft.world.item.PickaxeItem
// PHASE3: Configuration removed — use NeoForge ModConfigSpec or file-based config
// PHASE7: RecipeSorter removed in NeoForge 1.21 — no direct equivalent
