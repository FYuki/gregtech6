...
public class MultiTileEntityMiniPortalEndOfTime extends MultiTileEntityMiniPortal {
	...
	public ITexture sEndOfTimePortal = BlockTextureCopied.get(ST.block(MD.ExU, "dark_portal", ST.block(MD.ExS, "deepPortal", Blocks.portal)), SIDE_ANY, 0, UNCOLOURED, F, T, T), sEndOfTimePortalFrame = BlockTextureCopied.get(ST.block(MD.ExU, "dark_portal", ST.block(MD.ExS, "deepPortal", Blocks.STONE_BRICKS)), SIDE_ANY, 2, UNCOLOURED, F, F, F);
