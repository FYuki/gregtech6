...
public class Loader_Recipes_Vanilla implements Runnable {
	@Override public void run() {
		...
		CR.shaped(ST.make(Blocks.STONE_BRICKS                 , 1, 2), DEF, "h", "X", 'X', ST.make(Blocks.STONE_BRICKS, 1, 0));
		CR.shaped(ST.make(Blocks.STONE_BRICKS                 , 1, 3), DEF, "f", "X", 'X', ST.make(Blocks.double_stone_slab, 1, 8));
		...
		CR.shaped(ST.make(Blocks.STONE_BRICKS                 , 1, 0), DEF, "B", "B", 'B', ST.make(Blocks.stone_slab, 1, 5));
		CR.shaped(ST.make(Blocks.NETHER_BRICKS               , 1, 0), DEF, "B", "B", 'B', ST.make(Blocks.stone_slab, 1, 6));
		...
		CR.shaped(ST.make(Blocks.OAK_PLANKS                     , 1, 0), DEF, "B", "B", 'B', ST.make(Blocks.wooden_slab, 1, 0));
		CR.shaped(ST.make(Blocks.OAK_PLANKS                     , 1, 1), DEF, "B", "B", 'B', ST.make(Blocks.wooden_slab, 1, 1));
		CR.shaped(ST.make(Blocks.OAK_PLANKS                     , 1, 2), DEF, "B", "B", 'B', ST.make(Blocks.wooden_slab, 1, 2));
		CR.shaped(ST.make(Blocks.OAK_PLANKS                     , 1, 3), DEF, "B", "B", 'B', ST.make(Blocks.wooden_slab, 1, 3));
		CR.shaped(ST.make(Blocks.OAK_PLANKS                     , 1, 4), DEF, "B", "B", 'B', ST.make(Blocks.wooden_slab, 1, 4));
		CR.shaped(ST.make(Blocks.OAK_PLANKS                     , 1, 5), DEF, "B", "B", 'B', ST.make(Blocks.wooden_slab, 1, 5));
		CR.shaped(ST.make(Blocks.OAK_PLANKS                     , 1, 6), DEF, "B", "B", 'B', ST.make(Blocks.wooden_slab, 1, 6));
		CR.shaped(ST.make(Blocks.OAK_PLANKS                     , 1, 7), DEF, "B", "B", 'B', ST.make(Blocks.wooden_slab, 1, 7));
		...
		CR.shaped(ST.make(Blocks.NOTE_BLOCK              , 1, 0), DEF | DEL_OTHER_SHAPED_RECIPES , "WWW", "WRW", "WWW", 'W', OD.plankAnyWood, 'R', OD.itemRedstone);
		...
		RM.smash(ST.make(Blocks.STONE_BRICKS           , 1, 0), ST.make(Blocks.STONE_BRICKS, 1, 2));
		RM.smash(ST.make(Blocks.STONE_BRICKS           , 1, 1), ST.make(Blocks.COBBLESTONE, 1, 0));
		RM.smash(ST.make(Blocks.STONE_BRICKS           , 1, 2), ST.make(Blocks.COBBLESTONE, 1, 0));
		RM.smash(ST.make(Blocks.STONE_BRICKS           , 1, 3), ST.make(Blocks.COBBLESTONE, 1, 0));
		...
		RM.smash(ST.make(Blocks.TERRACOTTA        , 1, W), OM.dust(MT.Clay, 2*U));
		RM.smash(ST.make(Blocks.WHITE_TERRACOTTA, 1, W), OM.dust(MT.Clay, 2*U));
		...
		RM.Hammer .addRecipe1(T, 16,  16, ST.make(Blocks.NETHER_BRICKS       , 1, W), ST.make(Items.netherbrick, 3, 0));
		...
		RM.Crusher.addRecipe1(T, 16,  64, new long[] {10000, 9000, 8000, 7000}, ST.make(Blocks.NETHER_BRICKS       , 1, W), ST.make(Items.netherbrick, 1, 0), ST.make(Items.netherbrick, 1, 0), ST.make(Items.netherbrick, 1, 0), ST.make(Items.netherbrick, 1, 0));
		...
		RM.moss    (ST.make(Blocks.STONE_BRICKS , 1, 0), ST.make(Blocks.STONE_BRICKS, 1, 1));
		RM.growmoss(ST.make(Blocks.STONE_BRICKS , 1, 2), ST.make(Blocks.STONE_BRICKS, 1, 1));
		...
		RM.sawing(16,  16, F, 100, ST.make(Blocks.STONE_BRICKS                , 1, 0), ST.make(Blocks.stone_slab, 2, 5));
		RM.sawing(16,  16, F, 100, ST.make(Blocks.NETHER_BRICKS              , 1, 0), ST.make(Blocks.stone_slab, 2, 6));
		...
		RM.sawing(16,  48, F, 100, ST.make(Blocks.OAK_TRAPDOOR                  , 1, W), IL.Plank.get(3));
		...
		RM.sawing(16, 128, F, 100, ST.make(Blocks.NOTE_BLOCK                 , 1, W), IL.Plank.get(8), dust.mat(MT.Redstone, 1));
		...
		RM.sawing(16,  16, T,  50, ST.make(Blocks.MELON               , 1, W), ST.make(Items.melon, 8, 0), ST.make(Items.melon_seeds, 1, 0));
		...
		CR.shapeless(IL.Plank.get(3), CR.DEF_NCC, new Object[] {OreDictToolNames.saw, Blocks.OAK_TRAPDOOR             });
		...
		CR.shapeless(IL.Plank.get(8), CR.DEF_NCC, new Object[] {OreDictToolNames.saw, Blocks.NOTE_BLOCK            });
		...
		RM.Slicer       .addRecipe2(T, 16,   16, ST.make(Blocks.MELON      , 1, W), IL.Shape_Slicer_Eigths.get(0), ST.make(Items.melon, 8, 0), ST.make(Items.melon_seeds, 1, 0));
		...
		RM.Shredder     .addRecipe1(T, 16,128,  6000, ST.make(Blocks.MELON, 1, W), IL.Remains_Fruit.get(9));
		...
		RM.Bath         .addRecipe1(T,  0,   16, ST.make(Blocks.TERRACOTTA, 1, 0), FL.mul(tDye, 1, 16, T), NF, ST.make(Blocks.WHITE_TERRACOTTA, 1, 15-i));
		...
		RM.Bath         .addRecipe1(T,  0,   16, ST.make(Blocks.WHITE_TERRACOTTA, 1, W), MT.Cl.fluid(U20, T), NF, ST.make(Blocks.TERRACOTTA, 1, 0));
		...
		RM.Chisel       .addRecipe1(T, 16,   16, ST.make(Blocks.STONE     , 1, W), ST.make(Blocks.STONE_BRICKS, 1, 3));
		RM.Chisel       .addRecipe1(T, 16,   16, ST.make(Blocks.STONE_BRICKS, 1, 0), ST.make(Blocks.STONE_BRICKS, 1, 2));
		...
		RM.Squeezer     .addRecipe1(T, 16,  128,  6000, ST.make(Blocks.MELON      , 1, W), NF, FL.Juice_Melon.make(2250), IL.Remains_Fruit.get(9));
		...
		RM.biomass(ST.make(Blocks.MELON, 1, W));
		...
		RM.pack(ST.make(Items.netherbrick, 4, W), ST.make(Blocks.NETHER_BRICKS       , 1, 0));
