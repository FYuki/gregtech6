...
public class Loader_Recipes_Extruder implements Runnable {
	...
	public void run() {
		...
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  64, IL.Module_Stone_Generator.get(0), IL.Shape_Extruder_Ingot       .get(0), ST.make(Blocks.STONE_BRICKS, 1, 0));
		...
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  64, IL.Module_Stone_Generator.get(0), IL.Shape_SimpleEx_Ingot       .get(0), ST.make(Blocks.STONE_BRICKS, 1, 0));
		...
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, W), IL.Shape_Extruder_Ingot       .get(0), ST.make(Blocks.STONE_BRICKS, 1, 0));
		...
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.STONE, 1, W), IL.Shape_SimpleEx_Ingot       .get(0), ST.make(Blocks.STONE_BRICKS, 1, 0));
		...
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.COBBLESTONE, 1, W), IL.Shape_Extruder_Ingot       .get(0), ST.make(Blocks.STONE_BRICKS, 1, 0));
		...
		RM.Extruder.addRecipe2(T, F, F, F, T, 16,  32, ST.make(Blocks.COBBLESTONE, 1, W), IL.Shape_SimpleEx_Ingot       .get(0), ST.make(Blocks.STONE_BRICKS, 1, 0));
