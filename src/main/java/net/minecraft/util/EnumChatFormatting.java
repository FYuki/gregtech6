...
// PHASE3: stub - EnumChatFormatting was renamed to net.minecraft.ChatFormatting in 1.21
...
public enum EnumChatFormatting {
    ...
    private final ChatFormatting delegate;
    EnumChatFormatting(ChatFormatting d) { this.delegate = d; }
